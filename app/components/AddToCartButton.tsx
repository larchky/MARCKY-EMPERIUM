...
export default function AddToCartButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className="inline-flex items-center justify-center gap-2 rounded-md bg-accent px-4 py-2 text-sm font-black uppercase tracking-[0.12em] text-white transition hover:bg-[#bf2d73] disabled:cursor-not-allowed disabled:opacity-55"
    >
